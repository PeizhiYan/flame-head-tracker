...
cfg.model.topology_path = './models/head_template.obj' # edited by Peizhi
cfg.model.flame_model_path = './models/FLAME2020/generic_model.pkl' # edited by Peizhi
cfg.model.flame_lmk_embedding_path = './models/landmark_embedding.npy' # edited by Peizhi
