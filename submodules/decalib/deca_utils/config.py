...
cfg.pretrained_modelpath = os.path.join('models', 'deca_model.tar')
cfg.output_dir = ''
...
# ---------------------------------------------------------------------------- #
cfg.model = CN()
cfg.model.topology_path = os.path.join('models', 'head_template.obj')
# texture data original from http://files.is.tue.mpg.de/tbolkart/FLAME/FLAME_texture_data.zip
cfg.model.dense_template_path = os.path.join('models', 'texture_data_256.npy')
cfg.model.fixed_displacement_path = os.path.join('models', 'fixed_displacement_256.npy')
cfg.model.flame_model_path = os.path.join('models', 'FLAME2020/generic_model.pkl') 
cfg.model.flame_lmk_embedding_path = os.path.join('models', 'landmark_embedding.npy') 
cfg.model.face_mask_path = os.path.join('models', 'uv_face_mask.png') 
cfg.model.face_eye_mask_path = os.path.join('models', 'uv_face_eye_mask.png') 
cfg.model.mean_tex_path = os.path.join('models', 'mean_texture.jpg') 
cfg.model.tex_path = os.path.join('models', 'FLAME_albedo_from_BFM.npz') 
